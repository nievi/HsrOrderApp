...
namespace HsrOrderApp.SL.AdminService {
  public class AdminService : IAdminService {
    ...
    [PrincipalPermission(SecurityAction.Demand, Role = Roles.SUPPLYMGMT)]
    ...
    public GetSuppliersResponse GetSuppliersByCriteria(GetSuppliersRequest request) {
      ...
      IQueryable<Supplier> suppliers = bc.GetSuppliersByCriteria(request.SearchType, request.AccountNumber, request.SupplierName);
