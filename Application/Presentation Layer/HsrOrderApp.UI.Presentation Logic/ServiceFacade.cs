...
namespace HsrOrderApp.UI.PresentationLogic {
  public class ServiceFacade : IServiceFacade {
    ...
    public IList<CustomerListDTO> GetCustomersByCity(string city) {
      return getCustomers(CustomerSearchType.ByCity, default(string), city);
    }
    ...
    public IList<SupplierListDTO> GetSuppliersByName(string name) {
      return getSuppliers(SupplierSearchType.ByName, name, default(int));
    }
    ...
    public SupplierDTO GetProductConditionById(int id) {
      throw new NotImplementedException();
    }

    public IList<SupplierProductConditionDTO> GetAllProductConditions(SupplierDTO supplier) {
      throw new NotImplementedException();
    }

    public void StoreProductCondition(SupplierDTO supplier) {
      throw new NotImplementedException();
    }

    public void DeleteProductCondition(int productConditionId) {
      throw new NotImplementedException();
    }

    private IList<SupplierListDTO> getSuppliers(SupplierSearchType searchType, string name, int accountNumber) {
      try {
