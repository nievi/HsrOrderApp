...
namespace HsrOrderApp.UI.PresentationLogic {
  public interface IServiceFacade : IDisposable {
    ...
    SupplierDTO GetProductConditionById(int id);
    IList<SupplierProductConditionDTO> GetAllProductConditions(SupplierDTO supplier);
    void StoreProductCondition(SupplierDTO supplier);
    void DeleteProductCondition(int productConditionId);
