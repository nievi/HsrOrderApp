...
namespace HsrOrderApp.Test.BL.Services.DtoAdapters {
  ...
  public class CustomerAdapterTestCase {
    ...
    public void TestCustomersToDtos() {
      Customer customer = new Customer() { CustomerId = 1, Salutation = "FakeSal", Name = "FakeUserName", FirstName = "FakeFirstName", Version = 0 };
      ...
      Assert.AreEqual<string>(customer.Salutation, dto.Salutation);
    ...
    public void TestDtoToCustomer() {
      ...
      Assert.AreEqual<string>(dto.Salutation, customer.Salutation);
